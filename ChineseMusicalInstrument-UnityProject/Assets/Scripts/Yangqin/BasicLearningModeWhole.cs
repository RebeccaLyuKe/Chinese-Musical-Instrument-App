...
public class BasicLearningModeWhole : MonoBehaviour
{
    ...
    Button btn;
    public BasicLearningModeUpside basicLearningModeUpside=null;
    ...
    void Start()
    {
        basicLearningModeUpside=this.GetComponent<BasicLearningModeUpside>();
    ...
    public void ClickOnBasicModeButton()
    {
        ...
        if(!ActivateMode)
        {
            ...
            basicLearningModeUpside.ForcedExitAndChangeButton();
        }
        else
        {
    ...
    public void ForcedExitAndChangeButton()
    {
        ...
        if(highlighterStringUpside!=null) highlighterStringUpside.Off();
        if(highlighterStringDownside!=null) highlighterStringDownside.Off();
        beat=0;
        MoveTerm=0;
    }
